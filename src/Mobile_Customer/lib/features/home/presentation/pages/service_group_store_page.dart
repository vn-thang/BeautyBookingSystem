...
class ServiceGroupStoresView extends StatelessWidget {
  final int groupId;
  ...
  Widget build(BuildContext context) {
    context.read<ServiceGroupStoreBloc>().add(FetchServiceGroupStores(groupId));
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Hiện tại chưa có cửa hàng nào thuộc nhóm dịch vụ này.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
                    height: 1.45,
  ...
  Widget _buildStoreCard(BuildContext context, dynamic store) {
    final String? coverImageUrl = store.coverImageUrl;
    final bool hasImage =
        coverImageUrl != null && coverImageUrl.trim().isNotEmpty;

    final double rating = _ratingOf(store);
    final int reviewCount = _reviewCountOf(store);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if ((store.address ?? '').toString().trim().isNotEmpty)
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Icon(
