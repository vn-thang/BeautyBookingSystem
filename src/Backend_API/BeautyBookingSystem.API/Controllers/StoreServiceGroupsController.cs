...
namespace BeautyBookingSystem.API.Controllers
{
    ...
    public class StoreServiceGroupsController : ControllerBase
    {
        private readonly IStoreServiceGroupService _serviceGroupService;

        public StoreServiceGroupsController(IStoreServiceGroupService serviceGroupService)
        {
