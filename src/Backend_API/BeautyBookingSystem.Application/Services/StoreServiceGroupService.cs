...
{
    public class StoreServiceGroupService : IStoreServiceGroupService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ICurrentUserService _currentUserService;
        private readonly IMapper _mapper;

        public StoreServiceGroupService(IUnitOfWork unitOfWork, ICurrentUserService currentUserService, IMapper mapper)
        {
