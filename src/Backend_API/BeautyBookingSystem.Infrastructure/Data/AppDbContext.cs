...
namespace BeautyBookingSystem.Infrastructure.Data
{
    ...
    { 
        Id = 1, 
        Key = SystemConfigKeys.DefaultCommissionRate, 
        Value = "10", 
        Type = "number",
        Group = "Finance",
    ...
    { 
        Id = 2, 
        Key = SystemConfigKeys.DefaultMonthlyAppFee, 
        Value = "50000", 
        Type = "number",
        Group = "Finance",
    ...
    { 
        Id = 7, 
        Key = SystemConfigKeys.PenaltyCommissionPercent, 
        Value = "15", 
        Type = "number",
        Group = "Finance",
    ...
    { 
        Id = 3, 
        Key = SystemConfigKeys.FreeTrialDays, 
        Value = "30", 
        Type = "number",
        Group = "General",
    ...
    { 
        Id = 4, 
        Key = SystemConfigKeys.MaintenanceMode, 
        Value = "false", 
        Type = "boolean",
        Group = "General",
    ...
    { 
        Id = 6, 
        Key = SystemConfigKeys.SupportEmail, 
    ...
    { 
        Id = 8, 
        Key = SystemConfigKeys.BookingMinHours, 
        Value = "1", 
        Type = "number",
        Group = "Booking",
    ...
    { 
        Id = 9, 
        Key = SystemConfigKeys.CancelBeforeHours, 
        Value = "2", 
        Type = "number",
        Group = "Booking",
    ...
    { 
        Id = 10, 
        Key = SystemConfigKeys.GracePeriodMinutes, 
        Value = "15", 
        Type = "number",
        Group = "Booking",
    ...
    { 
        Id = 11, 
        Key = SystemConfigKeys.MaxCancelPerDay, 
        Value = "5", 
        Type = "number",
        Group = "Behavior",
    ...
    { 
        Id = 12, 
        Key = SystemConfigKeys.NoShowLimit, 
        Value = "5", 
        Type = "number",
        Group = "Behavior",
    ...
    { 
        Id = 13, 
        Key = SystemConfigKeys.BlockUserIfNoShow, 
        Value = "true", 
        Type = "boolean",
        Group = "Behavior",
