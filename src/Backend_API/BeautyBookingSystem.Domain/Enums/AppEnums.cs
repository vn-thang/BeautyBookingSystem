...
namespace BeautyBookingSystem.Domain.Enums
{
    ...
    // Giữ -1 Incomplete của bạn để không lỗi quy trình duyệt Cửa hàng
    public enum ApprovalStatus { Incomplete = -1, Pending, Approved, Locked }
    
    // Bỏ chữ Percentage bị lặp của Quan
    ...
    // Gộp chung Content của cả Admin và App Khách
    ...
    // Giữ nguyên các Enum xịn xò của nhánh develop
