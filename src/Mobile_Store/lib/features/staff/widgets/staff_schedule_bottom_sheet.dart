  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          'Nhân viên: ${widget.staff.fullName}', 
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          item.dayName, 
                          style: AppTextStyles.bodyText.copyWith(fontWeight: FontWeight.w600, fontSize: 13)
                        ),
                      ),
                        ...
                        child: item.isWorking
                            ? FittedBox( 
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    _buildTimeBox(item.startTime, () => _selectTime(index, true)),
                                    const Padding(
                                      padding: EdgeInsets.symmetric(horizontal: 4),
                                      child: Text('-'),
                                    ),
                                    _buildTimeBox(item.endTime, () => _selectTime(index, false)),
                                  ],
                                ),
                              )
                            : Align(
