...
class ServiceApi {
  ...
  static Future<List<ServiceGroupModel>> getGroupedServices(int storeId) async {
    final json = await ApiClient.get('/api/ServiceGroups?storeId=$storeId');
    List data = json is List ? json : (json['data'] ?? []);
  ...
  static Future<void> updateServiceGroup({
    ...
    await ApiClient.put('/api/ServiceGroups/$groupId', body: {
  ...
  static Future<void> updateService({
    ...
    await ApiClient.put('/api/Services/$serviceId', body: {
