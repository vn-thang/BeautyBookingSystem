...
//           Text(formatCurrency.format(payment.amount), style: const TextStyle(fontSize: 18, color: Color(0xFFDE4660), fontWeight: FontWeight.bold)),
          
//           if (payment.paidAt != null) ...[
//             const SizedBox(height: 4),
//             Text('Đã thanh toán: ${formatDate.format(payment.paidAt!)}', style: const TextStyle(fontSize: 12, color: Colors.grey)),
//           ],
