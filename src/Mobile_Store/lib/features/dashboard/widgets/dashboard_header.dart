                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: AppTextStyles.bodyText.copyWith(color: AppColors.white, fontSize: 18, fontWeight: FontWeight.bold),
                            maxLines: 1, 
                            overflow: TextOverflow.ellipsis, // Cắt chữ nếu tên quán quá dài
                          ),
                        ),
                        const SizedBox(width: AppSpacing.sm),
                        // 🎯 Đã thay bằng mũi tên kép đồng bộ
                        const Icon(Icons.keyboard_double_arrow_right, color: Colors.white70, size: 22), 
                      ],
                    ),
                    const SizedBox(height: AppSpacing.xs),
                    Text(
